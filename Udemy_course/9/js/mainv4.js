...
function arcs(data0, data1) {
  ...
  while (++i < n) {
    arc = arcs0[i];
    arcs0[i].innerRadius = innerRadius;
    arcs0[i].outerRadius = outerRadius;
    arcs0[i].next = arcs1[i];
  }
  return arcs0;
}
...
function transition(state) {
  ...
  var t1 = t0.transition().attrTween(
    "d",
    tweenArc(function (d, i) {
  ...
  var t2 = t1.transition().attrTween(
    "d",
    tweenArc(function (d, i) {
      return {
  ...
  var t3 = t2.transition().attrTween(
    "d",
    tweenArc(function (d, i) {
      return {
